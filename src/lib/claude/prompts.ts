...
- **過去走が少頭数(entry_countの目安として8頭以下)のレースの場合、その内容を額面通りに高評価しないこと。** 少頭数は競り合いが弱く楽に走れるため、着順が良い・着差が小さいだけでは実力の裏付けとして弱い。特にfinish_position/margin_secが欠損している(データが薄い)過去走を「悪くなさそう」と好意的に解釈するのは禁物で、判断材料が乏しいこと自体を明確にマイナス材料として扱うこと(データが無い=中立ではなく、信頼度を下げる要因)。多頭数・きわどい競り合いの中での実績の方を優先的に評価すること
