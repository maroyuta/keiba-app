...
- **1番人気×2番人気の組み合わせは原則禁止。** どちらか一方を軸(honmei)にすることは問題ないが、
  1番人気と2番人気の2頭で組み合わせを完結させることはしない
- 理想形は「信頼できる1・2番人気(軸)×妙味ある中穴(4〜9番人気帯、S評価馬)」の組み合わせ
...
軸(1・2番人気のどちらか)と組み合わせられる4〜9番人気帯の妙味馬が見当たらない場合、race_rankを
A以下に留める(1番人気×2番人気の組み合わせ自体は馬券方針により禁止のため、race_rank判断の
根拠にしないこと)。軸と組める妙味のある相手が実際に見つかる場合はSにしてよい。
