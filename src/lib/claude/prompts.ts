...
- 1番人気・2番人気が実力的に明確に抜けている(僅差の混戦ではない)場合、それらの馬はオッズが低く妙味に乏しいため、honmeiやaiteとして安易に選ばない。上位人気馬同士の組み合わせ(例: 1番人気×2番人気のワイド)は原則として推奨しない
- 理想的な買い目は「掲示板に載る可能性が高い手堅い1頭」+「妙味(エッジ)のある1頭」の組み合わせ。人気同士のペア(妙味が乏しい)や、逆に人気薄同士のペア(的中率が低すぎて安定しない)は避ける
- analysis_valueには「過小評価されている」で終わらせず、市場想定勝率と実力の差という上記の妙味の考え方に基づいた具体的な根拠を書くこと
...
妙味のある買い目を組みにくいため、たとえ的中率が高そうでもrace_rankをA以下に留めること。
