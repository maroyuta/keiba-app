...
(1〜2番人気の本命×2〜6番人気の相手×両券)へ機械的に当てはめると、レースごとに違うメンバー・頭数・レベル・
展開を読めておらず、市場と同じ"当たり前の型"を買うだけで余白(edge)が出ない(実測でも本命が1番人気ベタ買いに
負けている)。**人気帯の型(本命=市場上位・相手=2〜9番人気)は守ってよいが、"買う型か・見送る型か・どこが狙いか"は
...
- **★相手(aite)は2〜9番人気に限定する(1番人気同士は禁止)。** 「人気サイド同士だから妙味が無い」と
  機械的に決めつけないこと——本命1番人気×相手2番人気の同時複勝率は33.3%(自社データn=4,081)と、
  4〜9番人気帯より圧倒的に高い。ただし人気サイドは1点あたりの配当が薄いため、**この帯を買うかどうかは
  人気の数字ではなく「## 確率の出し方」節のEV検算で決めること。** 実オッズが薄すぎればEV<0.9で
  自動的に見送りになる(applyExpectedValueGate、重賞除く)。人気帯そのものは1〜9番人気であれば
  対象内、その中でどこを選ぶかは常にEV次第
- 理想形は「信頼できる1〜3番人気(軸)×確率×オッズで割の良い相手」の組み合わせ。2番人気でも9番人気でも
  固定せず、実際のオッズと推定実力の乖離(EV)で判断すること
...
| | 相手2番人気 | 相手3番人気 | 相手4〜6番人気 | 相手7〜9番人気 | 相手10番人気以下 |
|---|---|---|---|---|---|
| 本命1番人気 | **33.3%** | **26.3%** | 20.9%(4人気単独) | 7.6% | 3.6% |
| 本命2〜3番人気 | **19.5%** | ー | **14.9%** | **4.9%** | 2.2% |

**相手2〜3番人気は「人気サイド同士だから妙味が無い」と思い込まないこと。** 同時複勝率自体は高いが、
1点あたりの配当が薄いぶんEVで見送りになりやすいだけ。手順3の検算で自然に判定されるので、
ベースレートの時点で機械的に除外しない。
...
主軸にする**。
- S: **軸(honmei)と組み合わせて妙味(EV)のある買い目が実際に組める**レース(2〜9番人気帯等に、軸と
